...
export default function TourPage() {
  ...
  const allLocations = tourData.days.flatMap((day) =>
  ...
  const selectedDayData = tourData.days.find((day) => day.day === selectedDay);
            ...
            <div className="relative h-64 bg-gradient-to-r from-blue-600 to-indigo-600">
              ...
              <div className="relative h-full flex items-center justify-center text-white text-center p-6">
                <div>
                  ...
                  <p className="text-lg opacity-90">{tourData.description}</p>
                </div>
              </div>
            </div>
